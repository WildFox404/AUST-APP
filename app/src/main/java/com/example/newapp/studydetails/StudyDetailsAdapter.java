...
import com.example.newapp.studydetails.StudyDetailsCoursesActivity;
import com.example.newapp.studydetails.StudyDetailsLevel1;
import com.example.newapp.studydetails.StudyDetailsLevel2;


import java.util.ArrayList;


public class StudyDetailsAdapter extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<StudyDetailsLevel1> grade_list;
    private ArrayList<ArrayList<StudyDetailsLevel2>> item_list;
    private GradientDrawable border;
    private GradientDrawable child_border;
    public StudyDetailsAdapter(Context context, ArrayList<StudyDetailsLevel1> grade_list, ArrayList<ArrayList<StudyDetailsLevel2>> item_list) {
