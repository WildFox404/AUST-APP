...
public class StudyDetailsLevel1 {
    public StudyDetailsLevel1(String course_type_name, String credits_completed, String credits_required, String num_completed, String num_required, String relation_text) {
